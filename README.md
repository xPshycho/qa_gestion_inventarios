...
| E2E Playwright | `cd tests/e2e && npx --yes pnpm@10.12.1 test` | HTML local ignorado; CI conserva únicamente JUnit verificado | `playwright-e2e-*`, Jenkins Pipeline |
...
| E2E | Automatizada en GitHub Actions y Jenkins | Playwright cubre login, CRUD de productos, roles y responsive; CI desactiva HTML, screenshots, traces y videos y solo publica JUnit después del safety. |
